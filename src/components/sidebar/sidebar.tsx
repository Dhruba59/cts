...
const Sidebar: React.FC = ({}) => {
  ...
  return (
    <div className={`z-10 flex flex-col fixed top-[66px] min-h-screen h-auto md:relative max-w-[250px] border-r bg-white dark:bg-[#24303f] dark:border-r-gray-700 shadow-lg ${isSidebarOpen ? 'block' : 'hidden'} mb-[96px]`}>
