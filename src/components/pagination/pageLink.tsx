...
const PageLink = ({
  ...
  const customClassName = cn(
    "inline-flex text-xs md:text-base h-7 w-7 md:h-9 md:w-9 border rounded-sm border-neutral-500 text-black/80 items-center justify-center mx-1 hover:bg-neutral-100 cursor-pointer",
    className,
    {
