...
interface ReprintReportPdf {
  data: any;
}

const ReprintReportPdf = ({ data }: ReprintReportPdf) => {
  return (
    <Document style={{}}>
      <Page size="A4" style={styles.page}>
        ...
        >
          <Text>CTSdatabase : Subject Report</Text>
        </View>
        {/* horizontal bar */}
        <View
          style={{
        ...
        ></View>
        <View
          style={{ height: "4px", backgroundColor: "#5976de", width: "100%" }}
        ></View>
...
export default ReprintReportPdf;
