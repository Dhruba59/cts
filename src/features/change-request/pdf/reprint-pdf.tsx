  ...
  return (
    <View wrap={false}>
      <Text
        style={{
          fontSize: "10px",
          color: primaryColor === "red" ? "red" : "#5581c9",
          marginBottom: "8px",
        }}>
        {title} |{" "}
        <Text style={{ color: "black" }}>
          {" "}
          Identifiers matched closely enough that the odds are less than 1 in 10
          million to occur by chance
        </Text>{" "}
      </Text>
      <View>
        {/* header */}
        ...
        <View
          style={{
            display: "flex",
            flexDirection: "row",
            backgroundColor: primaryColor === "red" ? "#f9e5e6" : "#EEF6FB",
            padding: "3px",
            border: "1px",
            borderColor: primaryColor === "red" ? "red" : "blue",
          }}>
          <View style={{ width: "60px" }}>
            <Text style={{ fontSize: "9px", margin: "auto" }}>
              Initial Visit
            </Text>
          </View>
        ...
        <View>
          {data?.map((item: any, index: number) => (
            <View
              ...
              <Text
                style={{ width: "120px", padding: "2px", textAlign: "center" }}>
                {item?.indications}
              </Text>
              <Text
                style={{ width: "70px", padding: "2px", textAlign: "center" }}>
                {item?.lastStatus}
              </Text>
              <Text
                style={{
