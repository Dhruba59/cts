  ...
  return (
    ...
    >
      <div className="flex flex-col">
        ...
        <p>I, <span className="text-cyan-600">{firstName} {lastName}</span>, agree to explain to subjects the purpose of the subject registry
          and to have all subjects sign the current IRB-approved Subject Database Authorization prior to
          entering any subject data onto <a target="_blank" rel="noopener noreferrer" href="https://ctsdatabase.com" className="text-cyan-600">www.ctsdatabase.com</a>. Only those partial identifiers which have been
